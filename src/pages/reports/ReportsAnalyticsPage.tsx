...
export function ReportsAnalyticsPage() {
  ...
  const handleExportCsv = () => {
    const lines: string[][] = [
      ...
      ['Doanh thu', kpis.totalRevenue, kpis.previousTotalRevenue, revenueDelta.toFixed(2)],
      ['Occupancy', `${kpis.occupancyRate.toFixed(1)}%`, `${kpis.previousOccupancyRate.toFixed(1)}%`, occupancyDelta.toFixed(2)],
      ['Sản lượng Grade A (kg)', kpis.harvestedGradeAKg, kpis.previousHarvestedGradeAKg, yieldDelta.toFixed(2)],
